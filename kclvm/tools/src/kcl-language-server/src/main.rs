...
impl LanguageServer for Backend {
    ...
    async fn goto_definition(
        ...
        let definition = || -> Option<GotoDefinitionResponse> {
            ...
            // let first_elem = scope.elems.first().unwrap().1.borrow();

            // let start_position = Position::new(
            //     first_elem.start.line as u32 - 1,
            //     first_elem.start.column.unwrap_or(0) as u32,
            // );
            // let end_position = Position::new(
            //     first_elem.end.line as u32 - 1,
            //     first_elem.end.column.unwrap_or(0) as u32,
            // );
